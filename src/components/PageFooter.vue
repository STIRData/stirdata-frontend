      ...
      <div class="d-flex justify-content-between top">
        <div class="logo">
          <b-link :to="{ name: 'index' }">
            <img src="../assets/img/ic-logo-small.png" />
          </b-link>
        </div>
        <b-nav class="bottomnav">
          <ul>
            <li><b-link :to="{ name: 'index' }">Home</b-link></li>
        ...
        <b-nav class="social">
          <ul>
            <li><a href="https://www.facebook.com/STIRData-Action-112222720952173" target="_blank"><i class="fa fa-facebook-f"></i></a></li>
            <li><a href="https://twitter.com/stirdata" target="_blank"><i class="fa fa-twitter"></i></a></li>
          </ul>
        </b-nav>
      </div>
    </b-container>
